const CACHE = 'project-under-100-v19';
const APP_SHELL = ['./', './index.html', './manifest.json', './css/app.css', './css/tracking.css', './css/photos.css', './css/guidance.css', './css/reminders.css', './css/cloud.css', './css/profile.css', './css/schedule.css', './css/accessibility.css', './css/insights.css', './css/personalisation.css', './css/history.css', './css/pwa.css', './css/recovery.css', './css/reflection.css', './js/app.js', './js/storage.js', './js/tracking.js', './js/insights.js', './js/photos.js', './js/cloud.js', './js/cloud-config.js', './js/workout-player.js', './data/programme.js', './icons/icon-180.svg', './icons/icon-192.svg', './icons/icon-512.svg'];
