...
const initialState = () => ({ version: 8, startedAt: today(), profile: defaultProfile(), habits: {}, dailyLogs: {}, reviews: {}, photos: [], sessions: [], checkins: [], settings: { voice: true, dark: true, remindersEnabled: true, reminder: '07:00', lastReminderDate: null } });
